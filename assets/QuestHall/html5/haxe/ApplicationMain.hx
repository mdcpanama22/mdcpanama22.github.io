...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Quest Hall", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Quest Hall", null, 900, 900);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Quest Hall";
		app.meta["name"] = "Quest Hall";
